...
DROP INDEX IF EXISTS indx_threads_forum_created;
...
CREATE INDEX indx_threads_forum_created ON threads (forum, created);
...
CREATE INDEX indx_posts_thread_parent_id ON posts (thread, forum, parent);
